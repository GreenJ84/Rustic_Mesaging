    ...
    html! {
        <div id="sidebar-sub" class="chat-menu">
            ...
            <ul>
                <li
                    title="Friends"
                    class={format!("chat-menu-category{}",
                        if chat_ctx.current_chat.eq(&Chat::default()) {" active"} else {""}
                    )}
                    onmousedown={Callback::from({
                        let context = chat_ctx.clone();
                        move |_| {
                            context.dispatch(ChatDispatch::UpdateCurrentChat(Chat::default()));
                        }
                    })}
                >
                ...
                <li title="Nitro" class={"chat-menu-category disabled"}>
                    <a disabled={true}>
                ...
                <li title="Shop" class={"chat-menu-category disabled"}>
                    <a disabled={true}>
