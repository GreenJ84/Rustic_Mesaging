...
#[function_component(ServerWelcome)]
pub fn server_welcome() -> Html {
    let server_ctx = use_context::<TServerContext>().unwrap();

    html! {
        <div id="main-content" class="server-welcome">
            ...
            <hr/>
            <h1>{format!("Welcome to {}", &server_ctx.current_server.name.clone())}</h1>
            ...
            <div id="channel-input">
                    ...
                    <textarea
                        disabled={true}
                        placeholder={"You do not have the permission to send messages in this channel"}
                        rows={1}
                    >
                    </textarea>
